...
TIME_TO_WAIT_FOR_TABLE_UPDATE = 24*60*60 #in seconds
...
def fill_gap(df, max_time_interval_second, type_of_sensor, aggregation, forecast_horizon, plot=False):
    ...
    if stop_timestamp > int(next_stop_datetime.timestamp()): # if we are missing at least one data between the end of the database and now
